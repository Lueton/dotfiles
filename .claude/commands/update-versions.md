...
- `fedora-42-general/scripts/languages.sh` — `NVM_VERSION`, `PNPM_VERSION`, `PYTHON_VERSION`, `JAVA_17`, `JAVA_21`, `MAVEN_VERSION`
...
- **pnpm**: https://registry.npmjs.org/pnpm/latest — `version` field of the JSON response
...
- **Maven via sdkman**: Check https://api.sdkman.io/2/candidates/maven/linuxx64/versions/all or https://maven.apache.org/download.cgi — find the latest stable 3.9.x release
